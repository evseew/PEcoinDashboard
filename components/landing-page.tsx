...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-3 text-lime-400 font-bold text-lg">
                  ...
                  <span>Инновационно • Безопасно • Вдохновляюще</span>
                </div>
              </div>
              <Button
                onClick={() => scrollToSection("how-it-works")}
                className="group bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 hover:from-red-400 hover:via-pink-400 hover:to-purple-400 text-white font-bold px-10 py-5 rounded-full text-xl shadow-2xl shadow-red-500/30 hover:shadow-red-500/50 transition-all duration-500 hover:scale-110"
              >
      ...
      {/* What is PEcoin */}
      <section id="what-is-pecoin" className="relative py-20 md:py-32 z-10">
        <div className="container mx-auto px-4">
      ...
      {/* How it works */}
      <section id="how-it-works" className="relative py-20 md:py-32 z-10 overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              ...
              <p className="text-2xl text-lime-300 font-semibold">
            ...
            <div className="grid md:grid-cols-2 gap-10 mb-16">
              ...
              <Card className="group relative bg-gradient-to-br from-gray-900 via-gray-950 to-black backdrop-blur-xl border border-lime-400/40 rounded-3xl hover:border-lime-400/70 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:shadow-lime-400/30 overflow-hidden">
                <CardContent className="relative z-10 p-10">
                  <div className="flex flex-col items-center md:flex-row md:items-start gap-6 mb-8">
                    <div className="relative">
                      <div className="bg-gradient-to-r from-lime-400 to-green-400 rounded-2xl p-5 group-hover:animate-pulse shadow-lg shadow-lime-500/30">
                    ...
                    <h3 className="text-3xl md:text-4xl font-black text-lime-300 text-center md:text-left">
                      Для Про-Геймеров (10+)
                    </h3>
                  </div>
              ...
              <Card className="group relative bg-gradient-to-br from-gray-900 via-gray-950 to-black backdrop-blur-xl border border-yellow-400/40 rounded-3xl hover:border-yellow-400/70 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:shadow-yellow-400/30 overflow-hidden">
                <CardContent className="relative z-10 p-10">
                  <div className="flex flex-col items-center md:flex-row md:items-start gap-6 mb-8">
                    <div className="relative">
                      <div className="bg-gradient-to-r from-yellow-400 to-orange-400 rounded-2xl p-5 group-hover:animate-pulse shadow-lg shadow-yellow-500/30">
                    ...
                    <h3 className="text-3xl md:text-4xl font-black text-yellow-300 text-center md:text-left">
                  ...
                  <p className="text-xl md:text-2xl text-center">
                    ...
                    <span className="text-lime-400 font-bold">PEcoin</span> — нашу лагерную монету.
                      ...
                      <p className="text-2xl md:text-3xl font-bold text-lime-300 text-center leading-snug">
                        <Zap className="inline-block w-8 h-8 mr-3 text-lime-300 animate-fast-pulse" />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <div className="relative inline-block mb-8">
                <div className="bg-gradient-to-r from-green-400 to-emerald-400 rounded-full p-6 shadow-2xl shadow-green-400/50">
              ...
              <h2 className="text-4xl md:text-6xl font-black text-white mb-8">Это безопасно?</h2>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="text-center group">
                    <div className="relative mb-6">
                      <div className="bg-gradient-to-r from-red-500 to-pink-500 rounded-2xl p-6 w-20 h-20 mx-auto flex items-center justify-center shadow-lg shadow-red-500/50 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <h3 className="text-xl font-bold text-red-400 mb-3">Zero Investment</h3>
                    <p className="text-gray-400">Никаких финансовых вложений от родителей или детей</p>
                  </div>
                  <div className="text-center group">
                    <div className="relative mb-6">
                      <div className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl p-6 w-20 h-20 mx-auto flex items-center justify-center shadow-lg shadow-blue-500/50 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <h3 className="text-xl font-bold text-blue-400 mb-3">Easy Setup</h3>
                    <p className="text-gray-400">Phantom кошелёк не требует банковских данных</p>
                  </div>
                  <div className="text-center group">
                    <div className="relative mb-6">
                      <div className="bg-gradient-to-r from-purple-500 to-violet-500 rounded-2xl p-6 w-20 h-20 mx-auto flex items-center justify-center shadow-lg shadow-purple-500/50 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <h3 className="text-xl font-bold text-purple-400 mb-3">Closed System</h3>
                    <p className="text-gray-400">Все операции только внутри лагерной экосистемы</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-3xl text-lime-400 font-bold">Практически ничего! 🚀</p>
            </div>
            ...
            <Card className="bg-gray-900 backdrop-blur-2xl border border-lime-400/30 rounded-3xl shadow-2xl shadow-lime-400/10">
              <CardContent className="p-8 md:p-12">
                <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
                  ...
                  <div className="bg-gradient-to-r from-blue-900/40 to-purple-900/40 rounded-3xl p-6 border border-blue-400/30">
                    <div className="flex items-center gap-8">
                      ...
                      <div className="flex-1">
                        <h3 className="text-xl font-bold text-blue-400 mb-4">Скачать Phantom Wallet:</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <a
                            href="https://play.google.com/store/apps/details?id=app.phantom"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group flex items-center gap-3 bg-black rounded-xl p-3 hover:bg-gray-800 transition-all duration-300 hover:scale-105 shadow-lg"
                          >
                            <div className="bg-gradient-to-br from-green-400 to-blue-500 rounded-lg p-2 group-hover:scale-110 transition-transform duration-300">
                          ...
                          <a
                            ...
                            className="group flex items-center gap-3 bg-black rounded-xl p-3 hover:bg-gray-800 transition-all duration-300 hover:scale-105 shadow-lg"
                          >
                            <div className="bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg p-2 group-hover:scale-110 transition-transform duration-300">
                              <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <div className="bg-gradient-to-r from-green-900/40 to-emerald-900/40 rounded-3xl p-8 text-center border border-green-400/30">
                    <p className="text-2xl font-bold text-green-400 mb-4">
                      🔒 Никаких банковских карт или платежей не требуется
                    </p>
                    <p className="text-xl text-emerald-300">Только технологии • Только обучение • Только будущее!</p>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      {/* Dashboard section */}
      <section id="dashboard" className="relative py-20 md:py-32 z-10">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-6xl font-black text-white mb-8">
                ...
                >
                  <Collapsible open={openFaq === index} onOpenChange={() => toggleFaq(index)}>
                    <CollapsibleTrigger asChild>
                      <CardContent className="p-8 cursor-pointer hover:bg-gray-800/30 transition-colors duration-200 rounded-2xl">
                        <div className="flex items-center justify-between">
                          <h3 className="text-xl font-bold text-lime-400 text-left">{faq.question}</h3>
                          <ChevronDown
                            className={`w-6 h-6 text-lime-400 transition-transform duration-300 ${
      ...
      {/* Footer */}
      <footer className="relative py-16 z-10 border-t border-lime-400/20">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-6 mt-8">
              ...
              <div className="bg-gradient-to-r from-blue-400/20 to-purple-400/20 rounded-full p-3 border border-blue-400/30">
                <Network className="w-6 h-6 text-blue-400" />
              </div>
              <div className="bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-full p-3 border border-purple-400/30">
